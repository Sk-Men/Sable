...
// media blur
globalStyle(`.sable-blur-media img:not([class*="Avatar"]):not([class*="Emoticon"]), .sable-blur-media video`, blurEffect);
globalStyle(`.sable-blur-media img:not([class*="Avatar"]):not([class*="Emoticon"]):hover, .sable-blur-media video:hover`, unblurEffect);
